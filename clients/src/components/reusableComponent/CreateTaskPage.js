...
function CreateTaskPage(props) {
  const { closeModal, handleChange, submitHandler, task, data } = props;
  return (
    <>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md relative">
          ...
          >
            <InputFields
              ...
              placeholder="Task"
              className="border  border-[#86a4c3]  w-[100%] p-3 placeholder-[#000] border-l-0 rounded rounded-l-none outline-none focus:border-0"
            />
            <InputFields
              ...
              className="border  border-[#86a4c3]  w-[100%] placeholder-[#000] p-3 border-l-0 rounded rounded-l-none outline-none  focus:border-0"
            />
            <div className="flex items-center  mb-4 relative">
              ...
              <select
                ...
                onChange={handleChange}
                className="border border-[#86a4c3] w-[100%] p-3  outline-none placeholder-[#fff]  text-[#000]  focus:border-0 border-l-0"
              >
